...
try:
    ...
    line_color='black',fill_color=['royalblue',['black', '#fdbe72']*7], font_size=14,height=32
        ))])
    ...
    line_color='black',fill_color=['royalblue',['black', '#fdbe72']*7], font_size=14,height=36))])
